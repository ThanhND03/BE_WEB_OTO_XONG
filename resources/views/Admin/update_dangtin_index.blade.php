...
<body>
    ...
    <section id="wrapper">
        ...
        <setion id="wp-content">
                ...
                <form action="/Admin/list_dangtin_index/update/{{ $product_index->id }}" method="post" class="form_dangtin" enctype="multipart/form-data"> 

                    @method('PATCH')
                    @csrf

                    <input type="hidden" name="sid" value="{{ $product_index->id}}" >
                    <h1>Sửa Đăng Tin</h1>
                    <hr>
                        ...
                        <div class="push_picture">          
                            <div class="upload">
                                ...
                                {{-- <img src=" --}}
                                    ...
                                    <img id="img_1" src="{{ asset('uploads/'.$product_index->txtpicture) }}" >
                                    @else 
                    ...
                    <div class="form_input_chung">
                        <div class="input_box">
                            ...
                            <input type="text" name="hangsx" value="{{ $product_index->hangsx}}" >
                        </div>
                    </div>
                    ...
                    <div class="form_input_chung">
                        <div class="input_box">
                            ...
                            <input type="text" name="dongxe" value="{{ $product_index->dongxe}}">
                        </div>
                    </div>
                    ...
                    <div class="form_input_chung">
                        <div class="input_box">
                            ...
                            <input type="text" name="namsx" value="{{ $product_index->namsx}}">
                        </div>
                    </div>
                    ...
                    <div class="form_input_chung">
                        <div class="input_box">
                            ...
                            <input type="text" name="phienban" value="{{ $product_index->phienban}}">
                        </div>
                    </div>
                    ...
                    <div class="form_input_chung">
                        <div class="input_box">
                            ...
                            <input type="number" name="sokmdadi" value="{{ $product_index->sokmdadi}}"> <span style="position: relative;top: -30px;left: 750px;color: #81808095;">Km</span>
                        </div>
                    </div>
                    ...
                    {{-- <div class="form_input_chung">
                        ...
                        <div class="radio_tile_group" id="radio_tile_group">
                            ...
                            <div class="input_container">
                                <input type="radio" id="tudong" name="hopso" value="Tự Động" {{ $product_index->hopso}}>
                            ...
                            <div class="input_container">
                                <input type="radio" id="sosan" name="hopso" value="Số Sàn" {{ $product_index->hopso}}>
                                <div class="radio_tile">
                            ...
                            <div class="input_container">
                                <input type="radio" id="bantudong" name="hopso" value="Bán Tự Động" {{ $product_index->hopso}}> 
                                <div class="radio_tile">
                    ...
                    <div class="form_input_chung">
                            <div class="input_box">
                                ...
                                <input type="number" name="giaban" value="{{ $product_index->giaban}}"><span style="position: relative;top: -30px;left: 740px;color: #81808095;">VND</span>
                            </div>
                    </div>
                    ...
                    <div class="form_input_chung">
                        ...
                        <div class="input_box_tin">
                            ...
                            <textarea name="title_tin" id="title_tin" cols="105" rows="5">{{ $product_index->tieudetin}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form_input_chung">
                        <div class="input_box_tin">
                            ...
                            - Tình trạng giấy tờ">{{ $product_index->motachitiet}}</textarea>
                        </div>
                    </div>
