...
<head>
    ...
    <title>ADMIN-Đăng Tin Index</title>
</head>
<body>
                   ...
                   <form action=""  id="search">
                    ...
                    <!-- END FORM SEARCH -->
                                ...
                                <!-- <div class="panel-body">
                                        ...
                                        <tbody>
                                            @foreach($product_index as $row)
                                                <tr>
                                                    ...
                                                    {{-- <td><img src="{{asset($row->txtpicture) }}" alt="img" width="50px" height="50px"></td> --}}
                                                    <td>
                                                        @if($row->txtpicture)
                                                    ...
                                                    <td>
                                                        {{-- <form action="/Admin/List_dangtin_index/delete/{{$row->id}}" method="POST" onsubmit="return ConfimDelete( this ) ">
                                                            @method('DELETE')
                                                            @csrf
                                                    ...
                                                    <td><a href="/Admin/list_dangtin_index/edit/{{$row->id}}" style="text-decoration: none"><span class="glyphicon glyphicon-edit" style="display: flex;justify-content: center"></span></a></td>
                                                </tr>
                                            @endforeach
                                    ...
                                    {{$product_index->links()}}
                                    <a style="font-size: 18px;padding-left: 50px;" href="{{route('AdminTinIndex')}}">Quay Lại</a>
