                    ...
                    <!-- END FORM SEARCH -->
                                ...
                                <!-- <div class="panel-body">
                                    <div class="table-responsive"> -->
                                        ...
                                        <tbody>
                                            @foreach($user as $row)
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{-- <form action="/Admin/Reg/delete/{{$row->id}}" method="POST" onsubmit="return ConfimDelete( this ) ">
                                                            @method('DELETE')
                                                            @csrf
                                                    ...
                                                    <td><a href="/Admin/list_reg/edit/{{$row->id}}" style="text-decoration: none"><span class="glyphicon glyphicon-edit" style="display: flex;justify-content: center"></span></a></td>
                                                </tr>
                                            @endforeach
                                        ...
                                        {{$user->links()}}
                                        <a style="font-size: 18px;padding-left: 50px;" href="{{route('AdminRegister')}}">Quay Lại</a>
