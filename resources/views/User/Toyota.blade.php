    ...
    <div id="wrapper">
        ...
        <div id="wp-content">
            <div class="container-content">
                ...
                <!-- end search-top -->
                <div id="hotnew">
                    <b class="text-top">Danh sách các mẫu xe Toyota</b>
                    <ul class="menu-hotnew">
                        <div class="img-hot"><a href="#"><img src="{{asset('fe-assets')}}/img/red.png" alt="img-xe"><span style="right:149px;">Toyota Wigo 1.2G</span></a>
                            <div class="text-card">
                                <ul class="text-card-1">
                                    Tự động
                                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<li>50.000 km</li>
                                </ul>
                                <b class="money">352 Triệu</b><br>
                                
                            </div>
                        </div>
                        <div class="img-hot"><a href="#"><img src="{{asset('fe-assets')}}/img/ToyotaRaize.png" alt="img-xe"><span style="right:185px;">Toyota Raize</span></a>
                            <div class="text-card">
                                <ul class="text-card-1">
                                    Tự động
                                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<li>Mới</li>
                                </ul>
                                <b class="money">552 Triệu</b>
                                
                            </div>
                        </div>
                        <div class="img-hot"><a href="#"><img src="{{asset('fe-assets')}}/img/ToyotaHilux.png"><span style="right:188px">Toyota Hilux</span></a>
                            <div class="text-card">
                                <ul class="text-card-1">
                                    Tự động
                                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<li>Mới</li>
                                </ul>
                                <b class="money">628 Triệu</b>
                                
                            </div>
                        </div>
                        <div class="img-hot"><a href="#"><img src="{{asset('fe-assets')}}/img/CorollaAltis.jpg" alt="img-xe"><span style="right:195px;">Corola Altis</span></a>
                            <div class="text-card">
                                <ul class="text-card-1">
                                    Tự động
                                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<li>Mới</li>
                                </ul>
                                <b class="money">719 Triệu</b>
                    ...
                    <ul class="menu-hotnew">
                        <div class="img-hot"><a href="#"><img src="{{asset('fe-assets')}}/img/vHFFWe6K2nc33dFtYx2fuslv3BNEOlBQtqjwPeGT.jpg" alt="img-xe"><span style="right:155px;">Toyota Vios 2008</span></a>
                            <div class="text-card">
                                <ul class="text-card-1">
                                    Tự động
                                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<li>400.000 km</li>
                                </ul>
                                <b class="money">250 Triệu</b>
                                
                            </div>
                        </div>
                        <div class="img-hot"><a href="#"><img src="{{asset('fe-assets')}}/img/ToyotaYaris.jpg" alt="img-xe"><span style="right:190px;">Toyota Yaris</span></a>
                            <div class="text-card">
                                <ul class="text-card-1">
                                    Tự động
                                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<li>Mới</li>
                                </ul>
                                <b class="money">684 Triệu</b>
                                
                            </div>
                        </div>
                        <div class="img-hot"><a href="#"><img src="{{asset('fe-assets')}}/img/black.png" alt="img-xe"><span style="right:162px;">Corolla Alltis cũ</span></a>
                            <div class="text-card">
                                <ul class="text-card-1">
                                    Tự động
                        ...
                        <div class="img-hot"><a href="#"><img src="{{asset('fe-assets')}}/img/LandCruiser300.png" alt="img-xe"><span style="right:151px;">Land Cruiser 300</span></a>
                            <div class="text-card">
                                <ul class="text-card-1">
                                    Tự động
                                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<li>Mới</li>
