            ...
            <div class="container">
                ...
                <div class="nav-bottom">
                    <div class="search">
                        ...
                        <form action="{{route('search_index')}}" method="get" id="search">
                    ...
                    <div class="menu_right">
                        <div class="login">
                            <button><a href="{{route('login')}}"><span style="padding-right: 5px"><i class="fa-solid fa-user"></i></span>Đăng nhập</a></button>
                        </div>

                        <div class="dangtin_login">       
                            <button><a href="{{route('login')}}"><span style="padding-right: 5px"><img src="{{asset('fe-assets')}}/img/add_listing_white_16_18.png" alt="Đăng tin" width="20px" style="position: relative; top: 3px;"></span>Đăng tin</a></button>
        ...
        <div id="wp-content">
            <div class="container-content">
                <div id="search-top">
                    ...
                    <div class="flex-bt">
                        <p><a href="{{route('toyota')}}">Toyota</a></p>
                        <p><a href="{{route('Mercedes')}}">Mercedes</a></p>
                ...
                <div id="hotnew">
                    ...
                    <ul class="menu-hotnew">
                        <div class="img-hot"><a href="#"><img src="{{asset('fe-assets')}}/img/audi2.jpg" alt="img-xe"><span style="right:220px;">Audi A9</span></a>
                            <div class="text-card">
                                <ul class="text-card-1">
                                    2023
                                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<li>Tự dộng</li>
                                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<li>5000 km</li>
                                </ul>
                                <b class="money">520000000 VND </b>
                                <p>Hà Nội</p>
                            </div>
                        </div>
                        <div class="img-hot"><a href="/html/BMW2.html"><img src="{{asset('fe-assets')}}/img/A4-1,46.jpg" alt="img-xe"><span style="right:220px;">Audi A4</span></a>
                            <div class="text-card">
                                <ul class="text-card-1">
                                    2020
                                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<li>Tự dộng</li>
                                ...
                                <b class="money">100000000 VND</b>
                                <p>Bắc Ninh </p>
                            </div>
                        </div>
                        <div class="img-hot"><a href="/html/AudiA4.html"><img src="{{asset('fe-assets')}}/img/FordRanger616-918.jpg" alt="img-xe"><span style="right:185px;">Ford Ranger</span></a>
                            <div class="text-card">
                                <ul class="text-card-1">
                                    2022
                                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<li>Tự Động</li>
                                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<li>25000</li>
                                </ul>
                                <b class="money">600000000 VND</b>
                                <p>Vũng Tàu</p>
                            </div>
                        </div>
                     
                        <div class="img-hot"><a href="/html/HuyndaiAccent.html"><img src="{{asset('uploads')}}/1697554073-product.jpg" alt="img-xe"><span style="right:165px;">Huyndai Accent</span></a>
                            <div class="text-card">
                                <ul class="text-card-1">
                                    2023
                                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<li>Tự dộng</li>
                                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<li>0 km</li>
                                </ul>
                                <b class="money">980000000 VND</b>
                                <p>Quảng Ninh</p>
                            </div>
                        </div>
                    </ul>
                    ...
                    <ul class="menu-hotnew">
                        <div class="img-hot"><a href="/html/CX-5Luxury.html"><img src="{{asset('uploads')}}/1697554140-product.jpg" alt="img-xe"><span style="right:220px;"> Audi Q2 </span></a>
                            <div class="text-card">
                                <ul class="text-card-1">
                                    2022
                                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<li>Số Sàn</li>
                                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<li>20000 km</li>
                                </ul>
                                <b class="money">520000000 VND</b>
                                <p>Quảng Ninh</p>
                            </div>
                        </div>
                        <div class="img-hot"><a href="#"><img src="{{asset('uploads')}}/1697641807-product.jpg" alt="img-xe"><span style="right:145px;">Mercedes GLS650</span></a>
                            <div class="text-card">
                                <ul class="text-card-1">
                                    2023
                                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<li>Tự dộng</li>
                                ...
                                <b class="money">420000000 VND</b>
                                <p>Thái Nguyên</p>
                            </div>
                        </div>
                        <div class="img-hot"><a href="#"><img src="{{asset('uploads')}}/1697554290-product.jpg" alt="img-xe"><span style="right:165px;">KiaMorning i10</span></a>
                            <div class="text-card">
                                <ul class="text-card-1">
                                    2022
                                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<li>Tự dộng</li>
                                ...
                                <b class="money">650000000 VND</b>
                                <p>Quảng Ninh</p>
                            </div>
                        </div>
                        <div class="img-hot"><a href="#"><img src="{{asset('uploads')}}/1697642026-product.jpg" alt="img-xe"><span style="right:220px;">Audi A2</span></a>
                            <div class="text-card">
                                <ul class="text-card-1">
                                    2018
                                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<li>Tự dộng</li>
                                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<li>45000 km</li>
                                </ul>
                                <b class="money">240000000</b>
                                <p>Bắc Ninh</p>
                            </div>
                        </div>
                    </ul>
                    <ul style="list-style: none; display: flex; text-align: center;" class="xemthem">
                        <li><a href="/html/Toyota.html">Xem thêm</a></li>
