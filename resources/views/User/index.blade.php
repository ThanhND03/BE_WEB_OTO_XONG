            ...
            <div class="container-content">
                ...
                <div id="hotnew">
                    <div class="form_list_sp">
                        <h1 class="title_sp">Tin đăng mới nhất</h1>
                        ...
                        <ul style="list-style: none; display: flex; text-align: center;" class="xemthem">
                            <li><a href="{{route('AllProduct')}}">Xem thêm</a></li>
                            <li><img src="{{asset('fe-assets')}}/img/chevrons-down_20_20.png" alt="" width="23px" ></li>
                        </ul>
                    </div>
